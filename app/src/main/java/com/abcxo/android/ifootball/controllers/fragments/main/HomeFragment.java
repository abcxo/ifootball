...
import com.abcxo.android.ifootball.controllers.adapters.HomeRecyclerViewAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new HomeRecyclerViewAdapter(TweetRestful.getInstance().getHomeTweets()));
